			 ...
			 response.setContentType("text/html;charset=UTF-8");
			    ...
			    PrintWriter out = response.getWriter();
		            ...
		            /*   String contact=request.getParameter("phone"); */
						...
						if(connection==null)
						{
							pw.write("<html><body><h1>Error</h1><b>Cannot connect to db!! Contact Admin!!</b></body></html>");
						}
						else
						{
						        ps_sl = connection.prepareStatement("select fname from listing l, category c where email = ?");
								ps_sl.setString(1, email);
								
								ps_sl.execute();
								rs = ps_sl.getResultSet();
								if(rs.next())
								{
									pw.write("<html><body><h1>Error</h1><b>Email already exists! You duplicate!!</b></body></html>");
								}
								else
								{
								   String jdbc_insert_sql = "INSERT INTO category(category,title,subcategory,email,address,day,open,close,package,content,linkone,linktwo,linkthree,map,coverimg,logo,img,bimg,gimg,video)VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
						 ...
						 /*  	 ps.setString(4, contact);*/
						   	 ...
						   	 ps.setNString(6, days);
						   	      ...
						   	      ps.setString(9, ptype);
						   	         ...
						   	         ps.setString(12, secondlink);
						   	         ps.setString(13, thirdlink);
						   	      ps.setString(14, map);
