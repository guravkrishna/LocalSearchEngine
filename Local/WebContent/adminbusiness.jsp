...
String sql ="SELECT DISTINCT name FROM admincategory order by name";
				...
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						...
						<div class="hom-cre-acc-left hom-cre-acc-right">
							<div class="">
								<form class="" action="./AddBusiness" method="post" enctype="multipart/form-data">
									<div class="row">
...
%>
									...
									try{ 
										connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
										statement=connection.createStatement();
										String sql ="SELECT DISTINCT name FROM adminsubcategory order by name";
										System.out.println(sql);
										resultSet = statement.executeQuery(sql);%>
