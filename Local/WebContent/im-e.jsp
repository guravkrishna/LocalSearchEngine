		...
		<div class="container">
			<div class="row">
				<div class="dir-alp-tit">
					<h1>Industrial machinery and equipments supplies</h1>
					<ol class="breadcrumb">
						<li><a href="#">Home</a> </li>
							...
							<ul>
								...
								<li>
									<a href="listing-details.html">
										...
										<div class="list-left-near lln2">
											<h5>Property Getaways</h5> <span>City: Bengaluru</span> </div>
								...
								<li>
									<a href="listing-details.html">
										...
										<div class="list-left-near lln2">
											<h5>Home Trends</h5> <span>City: Bengaluru</span> </div>
								...
								<li>
									<a href="listing-details.html">
										...
										<div class="list-left-near lln2">
											<h5>Security System</h5> <span>City: Bengaluru</span> </div>
						...
						<div class="dir-alp-con-right-1">
							<div class="row">
								...
								<div class="row span-none">
									<h3 style="text-align:center"> List Of Popular Industrial Machinery and Equipments </h3><br>
									<div class="col-md-4">
