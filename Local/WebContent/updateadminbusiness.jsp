...
String sql ="SELECT * FROM adminbusi where id="+id;
...
%>
								<form class="" action="updateprocessthree.jsp" method="" >
								<input type="hidden" name="id" value="<%=resultSet.getString("id") %>">
									<div class="row">
										...
										<div class="input-field col s6">
											<input id="last_name" type="text" class="validate" name="lname" value="<%=resultSet.getString(3) %>">
											<label for="last_name">Last Name</label>
										</div>
									</div>
									<div class="row">
										<div class="input-field col s12">
											<input id="list_name" type="text" class="validate" name="title" value="<%=resultSet.getString(4) %>">
											<label for="list_name">Business Title</label>
										</div>
									</div>
									<div class="row">
										<div class="input-field col s12">
											<input id="list_phone" type="text" class="" name="phone" value="<%=resultSet.getString(5) %>">
									...
									<div class="row">
										<div class="input-field col s12">
											<input id="list_addr" type="text" class="validate" name="add" value="<%=resultSet.getString(7) %>">
											<label for="list_addr">Address</label>
										</div>
									</div>
									<div class="row">
										<div class="input-field col s12"> 
											 <select name="btype" value="<%=resultSet.getString(8) %>">
									...
									<div class="row">
										<div class="input-field col s12">
											<input id="list_addr" type="text" class="validate" name="city" value="<%=resultSet.getString(9) %>">
											<label for="list_addr">City</label>
										</div>
									</div>
									 <div class="row">
										<div class="input-field col s12">
											 <select name="category" id="continent" value="<%=resultSet.getString(10) %>">
 		...
 		<!-- <div class="row" >
								...
								<div class="row">
									...
									<!-- <input type="text" name="opentime"> -->
										 <select name="open" value="<%=resultSet.getString(12) %>">
									...
									<div class="input-field col s6">
										 <select name="close" value="<%=resultSet.getString(13) %>">
									...
									<div class="row">
										<div class="input-field col s12">
											<input type="text"  name="desc" placeholder="description" value="<%=resultSet.getString(14) %>">
									...
									<div class="row">
										<div class="input-field col s12">
											<input type="text"  name="link" value="<%=resultSet.getString(15) %>">
											<!-- <label for="list_addr">City</label> -->
										</div>
										<div class="input-field col s12">
											<input  type="text"  name="secondlink" value="<%=resultSet.getString(16) %>">
											<!-- <label for="list_addr">City</label> -->
										</div>
									</div>
									...
									<div class="row">
										<div class="input-field col s12">
											<input type="text"  name="map" value="<%=resultSet.getString(17) %>">
