			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#"> Add basic information</a> </li>
								...
								<div class="box-inn-sp ad-inn-page">
									<div class="tab-inn ad-tab-inn">
										<div class="hom-cre-acc-left hom-cre-acc-right">
											<div class="">
												<form class="" action="BasicinfouserServlet" method="post">
													<div class="row">
														<div class="input-field col s12">
															<input name="name" type="text" class="validate"  name="fname" required pattern="[a-zA-Z]+" title="enter  valid name">
													...
													<div class="row">
														<div class="input-field col s12">
															<input name="contact" type="text" class="validate"  pattern="[789][0-9]{9}" title="Enter digits only" required>
