		...
		<%@include file="Admin_header.html" %>
			...
			<div class="sb2-2">
				...
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Add New Sub Category</h4> <a class="dropdown-button drop-down-meta drop-down-meta-inn" href="#" data-activates="dr-list"><i class="material-icons">more_vert</i></a>
						...
						<div class="hom-cre-acc-left hom-cre-acc-right">
							<div class="">
								<form class="" action="./AdminSubCategory" method="post" enctype="multipart/form-data">
									<div class="row">
 		...
 		<div class="row" >
								...
								<!-- <div class="row">
									...
									<div class="row">
										<div class="input-field col s12">
											<input type="text" id="" class="" name="desc" placeholder="description">
