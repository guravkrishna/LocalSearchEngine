...
%>
	...
	<section class="pg-list-1" style="background:url(NewUpload/<%=resultSet.getString(24) %>">
		<div class="container">
			<div class="row">
					<h1 style="color:white;">	<b><%=resultSet.getString(2) %></b> </h1>
				<div class="pg-list-1-left"> <a href="#"></a><br>
					...
					<p><b>Address:<h2><%=resultSet.getString(13) %></b></h2>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								<div class="list-pg-upro">
									...
									<p><%=resultSet.getString(19) %></p> <a class="waves-effect waves-light btn-large full-btn list-pg-btn" href="#!">Contact User</a> </div>
							</div>
						</div>
						<!--END LISTING DETAILS: LEFT PART 7-->
