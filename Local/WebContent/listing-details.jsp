...
<!-- Mirrored from rn53themes.net/themes/demo/directory/listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jul 2018 05:08:18 GMT -->
<head>
		...
		<div class="container top-search-main">
			<div class="row">
				<div class="ts-menu">
					<!--SECTION: LOGO-->
					<div class="ts-menu-1">
						<a href="main.html"><img src="images/aff-log.png" alt=""> </a>
					</div>
...
String sql ="select * from adduser where id=1";
...
%>
	...
	<section class="pg-list-1">
		<div class="container">
			<div class="row">
	<font size="32">	<font color="blue"><h1>	<b><%=resultSet.getString("firstname") %></b> </h1>  </font></font>
				<div class="pg-list-1-left"> <a href="#"></a><br>
					...
					<p><b>Address:</b><h2><%=resultSet.getString("address") %></h2>
					
					
					<div class="list-number pag-p1-phone">
						<ul>
							<li><i class="fa fa-phone" aria-hidden="true"></i> <h4><%=resultSet.getString("contact") %></h4></li>
							<li><i class="fa fa-envelope" aria-hidden="true"></i> <h4><%=resultSet.getString("email") %></h4></li>
					...
					<div class="list-pg-lt list-page-com-p">
						...
						<div class="pglist-p1 pglist-bg pglist-p-com" id="ld-abour">
							<div class="pglist-p-com-ti">
								<h3><span>About</span> <%=resultSet.getString("firstname") %></h3> </div>
						...
						<div class="pglist-p2 pglist-bg pglist-p-com" id="ld-ser">
							...
							<div class="list-pg-inn-sp">
								...
								<div class="row pg-list-ser">
									<ul>
										<li class="col-md-4">
											<div class="pg-list-ser-p1"><img src="images/services/ser1g.jp" alt="" /> </div>
						...
						<div class="pglist-p3 pglist-bg pglist-p-com">
							...
							<div class="list-pg-inn-sp">
								<div class="list-pg-upro">
									...
									<p>***(-----)***</p> <a class="waves-effect waves-light btn-large full-btn list-pg-btn" href="#!">Contact User</a> </div>
							</div>
						</div>
						<!--END LISTING DETAILS: LEFT PART 7-->
...
<!-- Mirrored from rn53themes.net/themes/demo/directory/listing-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Jul 2018 05:09:04 GMT -->
</html>
