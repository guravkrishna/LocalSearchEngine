			...
			<div class="sb2-2">
				...
				<div class="sb2-2-2">
					<ul>
						...
						<li class="active-bre"><a href="#"> Add other information</a> </li>
								...
								<div class="box-inn-sp ad-inn-page">
									<div class="tab-inn ad-tab-inn">
										<div class="hom-cre-acc-left hom-cre-acc-right">
											<div class="">
												<form class="" action="OtherinfoServlet" method="post">
										...
										<div class="input-field col s12">
											<select name="day">
												...
												<option value="Sunday">Sunday</option>
													...
													<div class="row">
														<div class="input-field col s12">
															<input name="paymentmode" type="text" class="validate">
													...
													<div class="row">
														<div class="input-field col s12">
															<input name="companyinfo" type="text" class="validate">
