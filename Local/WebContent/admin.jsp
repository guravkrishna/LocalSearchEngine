		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-6">
				...
				<ul id='top-menu' class='dropdown-content top-menu-sty'>
					...
					<li><a href="#" class="waves-effect"><i class="" aria-hidden="true"></i>Edit Profile</a> </li>
					<li><a href="#" class="waves-effect"><i class="" aria-hidden="true"></i>Change Password</a> </li>
					<li class="divider"></li>
			...
			<div class="sb2-1">
				...
				<div class="sb2-13">
					<ul class="collapsible" data-collapsible="accordion">
						...
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Add Business</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
									...
									<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Upload media</a>
									<div class="collapsible-body left-sub-menu">
									   <ul>
						...
						<li><a href="#" class="menu-active"><i class="fa fa-tachometer" aria-hidden="true"></i>Manage business</a> </li>
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Upgrade membership</a>
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Add product category</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
									<li><a href="#">Add product subcategory</a> </li>
									</ul>
							</div>
						</li>
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Manage Catgory</a>
					    <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Review and Rating Management</a>
						<div class="collapsible-body left-sub-menu">
								<ul>
						...
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i> Listing</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
									<li><a href="admin-all-listing.jsp">All listing</a> </li>
						...
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Business listing page according to</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
						...
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Order</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
									<li><a href="admin-all-order.jsp">View order</a> </li>
									<li><a href="#">Export order</a> </li>
									<li><a href="admin-search-order">Search order</a> </li>
								</ul>
							</div>
						</li>
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Transaction</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
						...
						<li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-list-ul" aria-hidden="true"></i>Advertise Position Management</a>
							<div class="collapsible-body left-sub-menu">
								<ul>
									<li><a href="admin-all-advertisement.jsp">View Advertisement List</a> </li>
								</ul>
							</div>
						</li>
