...
String sql ="SELECT * FROM adminbusi where id='"+search+"' or fname like '%"+search+"%' or lname like '%"+search+"%'";
 ...
 %>
					...
					<div class="tz-2-com tz-2-main">
						...
						<div class="split-row">
							<div class="col-md-12">
								...
								<!-- <form name="" action="searchbusiness.jsp">
								
							<span><input type="text" name="search"><input type="submit" value="Search" class="button1"></span>
								 -->
								<form class="app-search" action="searchbusiness.jsp">
	...
	%>
													<tr>
														...
														<td><span class="list-img"><img src="uploadimages/<%=resultSet.getString(19)%>" alt=""></span> </td>
														
														<td><a href="#"><span class="list-enq-name"><%=resultSet.getString(10)%></span><span class="list-enq-city"><%=resultSet.getString(9)%></span></a> </td>
														...
														<td> <a href="viewadminbusiness.jsp?id=<%=resultSet.getString("id")%>"><button type="button" value="view">View</button></a> </td>
														
													<td> <a href="updateadminbusiness.jsp?id=<%=resultSet.getString("id")%>"><button type="button" value="edit">Edit</button></a> </td>
